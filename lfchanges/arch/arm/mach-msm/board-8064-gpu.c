...
/*		{
			.gpu_freq = 487500000, //LF: from 487500000
			.bus_freq = 4,
			.io_fraction = 0,
		},*/
		{
			.gpu_freq = 487500000, //LF: from 400000000
			.bus_freq = 3,
			.io_fraction = 33,
		},
/*#else
...
//#endif
		...
		{
			.gpu_freq = 20000000, //LF: From 27000000
			.bus_freq = 0,
		},
	},
	.init_level = 0, //LF: From 0
	.num_levels = 5,
	.set_grp_async = NULL,
	.idle_timeout = HZ/10,
	.nap_allowed = true,
