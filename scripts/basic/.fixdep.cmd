cmd_scripts/basic/fixdep := gcc -Wp,-MD,scripts/basic/.fixdep.d -w -O3 -Wmissing-prototypes -Wstrict-prototypes -fomit-frame-pointer      -o scripts/basic/fixdep scripts/basic/fixdep.c  
