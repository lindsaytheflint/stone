...
#ifdef CONFIG_GPU_OVERCLOCK //LF
	F_GFX3D(487500000, pll2, 1,  2),
#endif
	F_END
};
...
//#endif
	...
	F_GFX3D(400000000, pll2,  1,  2),
#ifdef CONFIG_GPU_OVERCLOCK //LF
//	F_GFX3D(487500000, pll2, 1,  2), //LF:
	F_GFX3D(500000000, pll2, 1,  2), //LF:
	F_GFX3D(533333000, pll2, 1,  2), //LF:
//	F_GFX3D(487500000, pll15, 1,  2), //LF:
//	F_GFX3D(500000000, pll2, 2,  3),
#endif
	F_END
};
...
static unsigned long fmax_gfx3d_8064[MAX_VDD_LEVELS] __initdata = {
	...
	[VDD_DIG_NOMINAL] = 325000000, //LF: 325000000
#ifdef CONFIG_GPU_OVERCLOCK //LF
//	[VDD_DIG_HIGH]    = 487500000 // LF: 487500000
//	[VDD_DIG_HIGH]    = 500000000 // LF: 487500000
	[VDD_DIG_HIGH]    = 533333000 // LF: 487500000
#else
...
//ASUS BSP mini-porting --- GSBI2 porting	
	...
	CLK_LOOKUP("cam_clk",		cam1_clk.c,	"4-006c"),
        CLK_LOOKUP("cam_clk",		cam0_clk.c,	"4-003c"),  //ASUS_BSP LiJen "[A68][13M][NA][Others]Mini porting for 13M camera with ISP"
        CLK_LOOKUP("cam_clk",		cam0_clk.c,	"4-005e"),  //ASUS_BSP LiJen "[A68][13M][NA][Others]Mini porting for 13M camera with ISP"
...
#ifdef CONFIG_DEBUG_FS	//ASUS_BSP: fix for miniporting +++
