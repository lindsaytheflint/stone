...
//	PM8921_GPIO_OUTPUT(33, 0, HIGH),
	PM8921_GPIO_OUTPUT(20, 0, LOW), //HS_PATH_EN, Ledger
...
static struct led_info pm8921_led_info[] = {
	[0] = {
		.name			= "led:red",
		.default_trigger	= "keypad-touched",//ASUS_BSP simpson: add for keypad_bl ++
	},
};
...
apq8064_pm8921_platform_data __devinitdata = {
	...
	.vibrator_pdata = &pm8xxx_vibrator_pdata //ASUS BSP HANS+
};
