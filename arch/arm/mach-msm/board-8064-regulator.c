...
//	REGULATOR_SUPPLY("dsi1_vddio",		"mipi_dsi.1"),  //+++ ASUS_BSP miniporting 
...
struct regulator_init_data msm8064_saw_regulator_pdata_8921_s5 =
	...
	SAW_VREG_INIT(S5, "8921_s5",	       700000, 1350000); //LF: From 850000, 1300000 / 1450000
struct regulator_init_data msm8064_saw_regulator_pdata_8921_s6 =
	SAW_VREG_INIT(S6, "8921_s6",	       700000, 1350000); //LF: From 850000, 1300000 / 1450000

struct regulator_init_data msm8064_saw_regulator_pdata_8821_s0 =
	/*	      ID       vreg_name	min_uV  max_uV */
	SAW_VREG_INIT(8821_S0, "8821_s0",       700000, 1350000); //LF: From 850000, 1300000 / 1450000
struct regulator_init_data msm8064_saw_regulator_pdata_8821_s1 =
	SAW_VREG_INIT(8821_S1, "8821_s1",       700000, 1350000); //LF: From 850000, 1300000 / 1450000
//#else
//struct regulator_init_data msm8064_saw_regulator_pdata_8921_s5 =
//	/*	      ID  vreg_name	       min_uV   max_uV */
...
apq8064_rpm_regulator_init_data[] __devinitdata = {
	...
	RPM_LDO(L2,  0, 1, 0, 1100000, 1200000, "8921_s4",     0,     0), //LF: 1200000, 1200000   panel
	...
	RPM_LDO(L11, 0, 1, 0, 2600000, 2600000, NULL,          0,     0),   //ASUS_BSP miniporting ++  //LF: 3100000, 3100000 panel
#else
	RPM_LDO(L11, 0, 1, 0, 3100000, 3100000, NULL,          0,     0),   //ASUS_BSP miniporting ++  //LF: 3100000, 3100000 panel
#endif
	...
	RPM_LDO(L24, 0, 1, 1,  750000, 1350000, "8921_s1", 10000, 10000), //LF: CPU or RAM?
