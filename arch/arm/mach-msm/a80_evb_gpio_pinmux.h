#ifndef __a80_evb_GPIO_PINMUX_H
#define __a80_evb_GPIO_PINMUX_H

#include "a68_gpio_pinmux_setting.h"

static struct msm_gpiomux_config a80_evb_msm8960_gpio_configs[] = {
        {
                .gpio = 0,
                .settings = {
...
/*		.gpio      = 17,
        ...
        {       //AP_PWR_KEY_N
                ...
                .settings = {
                        ...
                        [GPIOMUX_SUSPENDED] = &NC_cfg,//ASUS BSP HANS
                },
        },
        //ASUS_BSP+++ BennyCheng "config apq-mdm gpio default settings"
