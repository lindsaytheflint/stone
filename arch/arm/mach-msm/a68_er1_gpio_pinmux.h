#ifndef __a68_er1_GPIO_PINMUX_H
#define __a68_er1_GPIO_PINMUX_H

#include "a68_gpio_pinmux_setting.h"

static struct msm_gpiomux_config a68_er1_msm8960_gpio_configs[] = {
        {
                .gpio = 0,
                .settings = {
