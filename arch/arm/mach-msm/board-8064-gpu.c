...
//#else
#ifdef CONFIG_GPU_LOWER_NORMALFREQ //LF
		.ib = KGSL_CONVERT_TO_MBPS(2000),
#else
...
//void SetMAXGPUFreq(unsigned long freq) //LF: 
//{
...
int kgsl_3d0_getmaxfreq() {
	return kgsl_3d0_pdata.pwrlevel[0].gpu_freq;
}

void kgsl_3d0_setmaxfreq(int hz) {
	kgsl_3d0_pdata.pwrlevel[0].gpu_freq=hz;
}
#endif
