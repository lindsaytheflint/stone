...
//ASUS_BSP +++ Josh_Liao "remove sdc3 support for not support sd"
#undef CONFIG_MMC_MSM_SDC2_SUPPORT
#undef CONFIG_MMC_MSM_SDC3_SUPPORT
#undef CONFIG_MMC_MSM_SDC4_SUPPORT
//ASUS_BSP --- Josh_Liao "remove sdc3 support for not support sd"
