...
#if 0   //++ ASUS_BSP: Louis display-miniporting
	{
		.gpio = 2,
		.settings = {
...
#endif  //-- ASUS_BSP: Louis display-miniporting
	{
		.gpio = 3,
		.settings = {
			[GPIOMUX_ACTIVE]    = &cam_settings[2],
...
#define CAMR_RSTN 34
#endif //LiJen: don't need

static struct gpio apq8064_common_cam_gpio[] = {
//LiJen: for A68 camera +++
...
static struct msm_camera_sensor_flash_data flash_imx091 = {
	.flash_type	= MSM_CAMERA_FLASH_LED, //ASUS_BSP LiJen "[A68][13M][NA][Others]Mini porting for 13M camera with ISP"
};

static struct msm_camera_sensor_platform_info sensor_board_info_imx091 = {
	.mount_angle	= 90,  //ASUS_BSP LiJen "[A68][13M][NA][Others]Mini porting for 13M camera with ISP"
...
static struct msm_camera_sensor_info msm_camera_sensor_imx091_data = {
	...
	.csi_if	= 1,
	.camera_type = BACK_CAMERA_2D,
	.sensor_type = YUV_SENSOR, //ASUS_BSP LiJen "[A68][13M][NA][Others]Mini porting for 13M camera with ISP"
