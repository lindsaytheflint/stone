#ifndef __A66_ER3_GPIO_PINMUX_H
#define __A66_ER3_GPIO_PINMUX_H

#include "a68_gpio_pinmux_setting.h"

static struct msm_gpiomux_config a68_evb_msm8960_gpio_configs[] = {
        {
                .gpio = 0,
                .settings = {
...
//ASUS_BSP +++ Stimber "[a68][8M][NA][Others]Full porting for 8M camera with ISP"
	{
		...
		.settings = {
			[GPIOMUX_ACTIVE]    = &cam_settings[1], //LiJen mini porting
...
//joe1_++
        {
                .gpio = 12, //TS INTERRUPT: a68_SR1=TP_IRQ_N
                .settings = {
...
/*                .gpio = 84,
        ...
        {       //USB_SW_SEL
                .gpio = 86,
                .settings = {
					[GPIOMUX_ACTIVE] = &O_L_cfg,		// +++ ASUS_BSP mini-porting 
                    [GPIOMUX_SUSPENDED] = &O_L_cfg,
                },
        },
        {       //1.2M_MCLK_EN_N
