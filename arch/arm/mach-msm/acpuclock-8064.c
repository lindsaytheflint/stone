...
#ifdef CONFIG_CPU_LOWER_MINCLOCK
	[0]  = { {  378000, HFPLL, 2, 0, 0x1C },  950000, 1050000, 1 },
	[1]  = { {  384000, PLL_8, 0, 2, 0x00 },  950000, 1050000, 1 },
//	[0]  = { {  192000, PLL_8, 0, 2, 0x00 }, 1050000, 1050000, 1 },
//	[1]  = { {  384000, HFPLL, 0, 2, 0x00 }, 1050000, 1050000, 1 },
#else
...
//	{ 1, {  1512000, HFPLL, 1, 0, 0x38 }, L2(14), 1250000 },
	...
	{ 1, {  1674000, HFPLL, 1, 0, 0x3E }, L2(14), 1262500 }, //? 1112500
	{ 1, {  1728000, HFPLL, 1, 0, 0x40 }, L2(14), 1275000 }, //? 1137500
#else
#ifdef CONFIG_CPU_LOWER_MINCLOCK
	{ 1, {   192000, PLL_8, 0, 2, 0x00 }, L2(0),   950000 }, //850
#else
	{ 1, {   384000, PLL_8, 0, 2, 0x00 }, L2(0),   950000 },
#endif
...
static struct acpu_level acpu_freq_tbl_nom[] __initdata = {
	...
	{ 1, {  1674000, HFPLL, 1, 0, 0x3E }, L2(14), 1212500 }, //? 1112500
	{ 1, {  1728000, HFPLL, 1, 0, 0x40 }, L2(14), 1225000 }, //? 1137500
#else
#ifdef CONFIG_CPU_LOWER_MINCLOCK
	{ 1, {   192000, PLL_8, 0, 2, 0x00 }, L2(0),   900000 }, //850
#else
...
#ifdef CONFIG_CPU_LOWER_MINCLOCK
	{ 1, {   162000, PLL_8, 0, 2, 0x00 }, L2(1),   775000 },
	{ 1, {   192000, PLL_8, 0, 2, 0x00 }, L2(1),   775000 }, //850
//	{ 1, {   216000, HFPLL, 2, 0, 0x10 }, L2(0),   825000 },
//	{ 1, {   270000, HFPLL, 2, 0, 0x14 }, L2(0),   825000 },
//	{ 1, {   324000, HFPLL, 2, 0, 0x18 }, L2(0),   850000 },
//	{ 1, {   378000, HFPLL, 2, 0, 0x1C }, L2(0),   850000 },
#else
	{ 1, {   384000, PLL_8, 0, 2, 0x00 }, L2(0),   850000 }, //850
#endif // CONFIG_CPU_LOWER_MINCLOCK
 ...
 #ifdef CONFIG_CPU_OVERCLOCK2 //LF
//	{ 1, {  1782000, HFPLL, 1, 0, 0x42 }, L2(14), 1175000 }, //?
	{ 1, {  1836000, HFPLL, 1, 0, 0x44 }, L2(14), 1237500 }, //? 1187500
 #endif // CONFIG_CPU_OVERCLOCK2
#endif // CONFIG_POWERSAVER
	{ 0, { 0 } }
};
...
#ifdef CONFIG_CPU_LOWER_MINCLOCK //LF
	.stby_khz = 192000, 
#else
	.stby_khz = 384000, 
#endif
