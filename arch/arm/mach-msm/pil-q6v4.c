...
static int __init pil_q6v4_init(void)
{
    ...
    if( (g_A68_cpuID >= 716) && (g_A68_cpuID <= 719) ) {
        ...
        sprintf((char *)(q6_0), "q6_718.b00");
        sprintf((char *)(q6_1), "q6_718.b01");
        sprintf((char *)(q6_3), "q6_718.b03");
        sprintf((char *)(q6_4), "q6_718.b04");
        sprintf((char *)(q6_5), "q6_718.b05");
        sprintf((char *)(q6_6), "q6_718.b06");
        sprintf((char *)(q6_m), "q6_718.mdt");
    }
