...
#define CFG_SET_ISP_LED_MODE		49
#define CFG_SET_ISP_EFFECT_MODE	50
#define CFG_SET_ISP_WB_MODE	51
#define CFG_SET_ISP_EV_MODE	52
#define CFG_SET_ISP_SCENE_MODE	53
#define CFG_SET_ISP_CAF_MODE	54
#define CFG_SET_ISP_AECLOCK_MODE	55
#define CFG_SET_ISP_AWBLOCK_MODE	56
#define CFG_SET_ISP_ISO_MODE	57
#define CFG_SET_ISP_FLICKER_MODE	58
#define CFG_GET_ISP_EXIF		59  //ASUS_BSP Stimber "Implement EXIF info for camera with ISP"
#define CFG_SET_ISP_AURA_VALUE	60
#define CFG_SET_ISP_GENERAL_CMD	61 //ASUS_BSP LiJen "[A68][13M][NA][Others]implement general command"
#define CFG_GET_ISP_GENERAL_CMD	62 //ASUS_BSP LiJen "[A68][13M][NA][Others]implement general command"
#define CFG_MAX			63
//ASUS_BSP ---

//ASUS_BSP +++ Stimber "Implement the interface for calibration"
#define ASUS_SET_I2C_REG               100
#define ASUS_GET_I2C_REG               101
//ASUS_BSP --- Stimber "Implement the interface for calibration"
...
#define CAMERA_EFFECT_VINTAGE2	15
#define CAMERA_EFFECT_LOMO		16
...
typedef enum {
  CAMERA_ISO_AUTO = 0,
  CAMERA_ISO_DEBLUR,
  CAMERA_ISO_50,  //ASUS_BSP LiJen "[A68][13M][NA][Others]implement ISO mode"
  CAMERA_ISO_100,
  CAMERA_ISO_200,
  CAMERA_ISO_400,
  CAMERA_ISO_800,
...
/* Any point Auto focus */
struct asus_isp_af_param_t {
    isp3a_af_mode_t mode;
...
enum msm_sensor_resolution_t {
	MSM_SENSOR_RES_FULL,
	MSM_SENSOR_RES_QTR,
	MSM_SENSOR_RES_FULL_HD,	//ASUS_BSP Stimber "Implement Full HD resolution"
	MSM_SENSOR_RES_10M,		//ASUS_BSP Stimber "Implement 10M ZSL resolution"
	MSM_SENSOR_RES_HYBRID,		//ASUS_BSP Stimber "Implement 6.35M Hybrid resolution"
	MSM_SENSOR_RES_4BIN,		//ASUS_BSP Stimber "Implement 4x4 binning resolution"
...
struct general_cmd_cfg {
      enum general_cmd_id_type cmd_id;
      int cmd_value;
};
//ASUS_BSP --- LiJen "[A68][13M][NA][Others]implement general command"
...
typedef struct {
	uint16_t addr; 
	uint16_t val;
}register_setting_A68;

typedef struct {
	int i2c_reg_rw_type;
	register_setting_A68 reg;
}asus_sensor_i2c_rw_t;
//ASUS_BSP --- Stimber "Implement the interface for calibration"
