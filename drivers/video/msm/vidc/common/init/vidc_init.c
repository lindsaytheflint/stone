...
static char *vidc_0 = NULL;
static char *vidc_1 = NULL;
static char *vidc_2 = NULL;
static char *vidc_3 = NULL;
static char *vidc_m = NULL;
module_param(vidc_0, charp, S_IRUGO | S_IWUSR);
module_param(vidc_1, charp, S_IRUGO | S_IWUSR);
module_param(vidc_2, charp, S_IRUGO | S_IWUSR);
module_param(vidc_3, charp, S_IRUGO | S_IWUSR);
module_param(vidc_m, charp, S_IRUGO | S_IWUSR);
//ASUS_BSP---
...
//ASUS_BSP+++
	vidc_0 = (char *) kmalloc(32, GFP_KERNEL);
    vidc_1 = (char *) kmalloc(32, GFP_KERNEL);
    vidc_2 = (char *) kmalloc(32, GFP_KERNEL);
    vidc_3 = (char *) kmalloc(32, GFP_KERNEL);
    vidc_m = (char *) kmalloc(32, GFP_KERNEL);
    if( (vidc_0 == NULL) || (vidc_1 == NULL) || (vidc_2 == NULL) || (vidc_3 == NULL) || (vidc_m == NULL) ) {
        pr_info("[vidc_init]: malloc(32) fail.\n");
    }
    memset( vidc_0, 0, 32 );
    memset( vidc_1, 0, 32 );
    memset( vidc_2, 0, 32 );
    ...
    pr_info("[vidc_init]: g_A68_cpuID=%d.\n", g_A68_cpuID);

    if( (g_A68_cpuID >= 716) && (g_A68_cpuID <= 719) ) {
        sprintf((char *)(vidc_0), "vidc_%d.b00", g_A68_cpuID);
        sprintf((char *)(vidc_1), "vidc_%d.b01", g_A68_cpuID);
        sprintf((char *)(vidc_2), "vidc_%d.b02", g_A68_cpuID);
        sprintf((char *)(vidc_3), "vidc_%d.b03", g_A68_cpuID);
        sprintf((char *)(vidc_m), "vidc_%d.mdt", g_A68_cpuID);
    }
    else {
        sprintf((char *)(vidc_0), "vidc_718.b00");
        sprintf((char *)(vidc_1), "vidc_718.b01");
        sprintf((char *)(vidc_2), "vidc_718.b02");
        sprintf((char *)(vidc_3), "vidc_718.b03");
        sprintf((char *)(vidc_m), "vidc_718.mdt");
    }

    pr_info("[vidc_init]: %s, %s, %s, %s, %s.\n", vidc_0, vidc_1, vidc_2, vidc_3, vidc_m);
//ASUS_BSP---
