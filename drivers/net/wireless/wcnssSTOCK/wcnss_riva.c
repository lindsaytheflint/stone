...
int wcnss_wlan_power(struct device *dev, struct wcnss_wlan_config *cfg, enum wcnss_opcode on)
{
	...
	if (on) {
		...
		if (rc) {
            ...
            //ASUS_BSP+++ "for /data/log/ASUSEvtlog"
            ASUSEvtlog("[wcnss]: wcnss_riva_vregs_on fail.\n");
            //ASUS_BSP--- "for /data/log/ASUSEvtlog"
            ...
            //ASUS_BSP+++ "for /data/log/ASUSEvtlog"
            ASUSEvtlog("[wcnss]: wcnss_riva_vregs_on.\n");
            //ASUS_BSP--- "for /data/log/ASUSEvtlog"
        }
		...
		if (rc) {
            ...
            //ASUS_BSP+++ "for /data/log/ASUSEvtlog"
            ASUSEvtlog("[wcnss]: WCNSS_WLAN_SWITCH_ON fail.\n");
            //ASUS_BSP--- "for /data/log/ASUSEvtlog"
            ...
            //ASUS_BSP+++ "for /data/log/ASUSEvtlog"
            ASUSEvtlog("[wcnss]: WCNSS_WLAN_SWITCH_ON.\n");
            //ASUS_BSP--- "for /data/log/ASUSEvtlog"
        }
        ...
        //ASUS_BSP+++ "for /data/log/ASUSEvtlog"
        ASUSEvtlog("[wcnss]: WCNSS_WLAN_SWITCH_OFF.\n");
        //ASUS_BSP--- "for /data/log/ASUSEvtlog"
        ...
        //ASUS_BSP+++ "for /data/log/ASUSEvtlog"
        ASUSEvtlog("[wcnss]: wcnss_riva_vregs_off.\n");
        //ASUS_BSP--- "for /data/log/ASUSEvtlog"
	}
