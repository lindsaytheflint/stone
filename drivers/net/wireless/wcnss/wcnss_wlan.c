...
static char *wcnss_0 = NULL;
static char *wcnss_1 = NULL;
...
static int __init wcnss_wlan_init(void)
{
    ...
    wcnss_0 = (char *) kmalloc(32, GFP_KERNEL);
    wcnss_1= (char *) kmalloc(32, GFP_KERNEL);
    ...
    if( (g_A68_cpuID >= 716) && (g_A68_cpuID <= 719) ) {
        sprintf((char *)(wcnss_0), "wcnss_%d.b00", g_A68_cpuID);
        sprintf((char *)(wcnss_1), "wcnss_%d.b01", g_A68_cpuID);
        ...
        sprintf((char *)(wcnss_0), "wcnss_719.b00");
        sprintf((char *)(wcnss_1), "wcnss_719.b01");
