...
static char *tzapps_0 = NULL;
static char *tzapps_1 = NULL;
static char *tzapps_2 = NULL;
static char *tzapps_3 = NULL;
static char *tzapps_m = NULL;
module_param(tzapps_0, charp, S_IRUGO | S_IWUSR);
module_param(tzapps_1, charp, S_IRUGO | S_IWUSR);
module_param(tzapps_2, charp, S_IRUGO | S_IWUSR);
module_param(tzapps_3, charp, S_IRUGO | S_IWUSR);
module_param(tzapps_m, charp, S_IRUGO | S_IWUSR);
//ASUS_BSP---
...
{
//ASUS_BSP+++
	tzapps_0 = (char *) kmalloc(32, GFP_KERNEL);
    tzapps_1 = (char *) kmalloc(32, GFP_KERNEL);
    tzapps_2 = (char *) kmalloc(32, GFP_KERNEL);
    tzapps_3 = (char *) kmalloc(32, GFP_KERNEL);
    tzapps_m = (char *) kmalloc(32, GFP_KERNEL);
    if( (tzapps_0 == NULL) || (tzapps_1 == NULL) || (tzapps_2 == NULL) || (tzapps_3 == NULL) || (tzapps_m == NULL) ) {
        pr_info("[tzapps]: malloc(32) fail.\n");
    }
    memset( tzapps_0, 0, 32 );
    memset( tzapps_1, 0, 32 );
    memset( tzapps_2, 0, 32 );
    memset( tzapps_3, 0, 32 );
    memset( tzapps_m, 0, 32 );

    pr_info("[tzapps]: g_A68_cpuID=%d.\n", g_A68_cpuID);

    if( (g_A68_cpuID >= 716) && (g_A68_cpuID <= 719) ) {
        sprintf((char *)(tzapps_0), "tzapps_%d.b00", g_A68_cpuID);
        sprintf((char *)(tzapps_1), "tzapps_%d.b01", g_A68_cpuID);
        sprintf((char *)(tzapps_2), "tzapps_%d.b02", g_A68_cpuID);
        sprintf((char *)(tzapps_3), "tzapps_%d.b03", g_A68_cpuID);
        sprintf((char *)(tzapps_m), "tzapps_%d.mdt", g_A68_cpuID);
    }
    else {
        sprintf((char *)(tzapps_0), "tzapps_718.b00");
        sprintf((char *)(tzapps_1), "tzapps_718.b01");
        sprintf((char *)(tzapps_2), "tzapps_718.b02");
        sprintf((char *)(tzapps_3), "tzapps_718.b03");
        sprintf((char *)(tzapps_m), "tzapps_718.mdt");
    }

    pr_info("[tzappss]: %s, %s, %s, %s, %s.\n", tzapps_0, tzapps_1, tzapps_2, tzapps_3, tzapps_m);
//ASUS_BSP---
