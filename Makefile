...
MAKEFLAGS += -w -rR --no-print-directory
...
HOSTCC       = gcc
HOSTCXX      = g++
HOSTCFLAGS   = -w -O3 -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer # //LF: -Wall 
HOSTCXXFLAGS = -O3
...
KBUILD_CFLAGS   := -w -Wundef -Wstrict-prototypes -Wno-trigraphs \
		   ...
		   -Wno-format-security \
		   -fno-delete-null-pointer-checks #//LF: -Wall
